...
public class UrlResource extends AbstractFileResolvingResource {
     ...
     * @see com.github.secretx33.resourceresolver.ResourceUtils#getFile(java.net.URL, String)
     */
    @Override
    ...
    public boolean equals(@Nullable Object obj) {
        return (this == obj || (obj instanceof UrlResource &&
                getCleanedUrl().equals(((UrlResource)obj).getCleanedUrl())));
    }
